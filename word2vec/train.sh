...
echo "bin/word2phrase -train data/_train2.tmp -output data/_train3.tmp -threshold 500 -debug 2"
bin/word2phrase -train data/_train2.tmp -output data/_train3.tmp -threshold 500 -debug 2
